...
public class MemberController {
    ...
    public String listMember(Model model) throws Exception {
    	List<FeedbackVO> students = memberService.readMemberList();
    ...
    public String readMember(@RequestParam("id") int id, Model model) throws Exception {
    	FeedbackVO student = memberService.readMember(id);
	...
	public String createMemberPost( @ModelAttribute("student") FeedbackVO vo) throws Exception {
    ...
    public String modifyMemberGet(@RequestParam("id") int id, Model model) throws Exception {
    	FeedbackVO student = memberService.readMember(id);
    	
		logger.info(" /modify?id=kang URL GET method called. then forward member_modify.jsp.");
        model.addAttribute("feedback", student);
        return "member/member_modify";
    }
    
    @RequestMapping(value = "/modify", method = RequestMethod.POST)
    public String modifyMemberPost(@ModelAttribute("student") FeedbackVO vo) throws Exception {
    ...
    public String deleteSchedule(@RequestParam("id") int id, Model model) throws Exception {
       memberService.deleteMember(id);
       
      logger.info(" /delete?id=OO URL called. then deletefeedback method executed.");
